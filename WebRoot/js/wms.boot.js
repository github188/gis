...
var bootPATH = __CreateJSPath("wms.boot.js");
//
...
document.write('<script src="' + bootPATH + 'local/wms.map.js?r='+ Math.random() +'" type="text/javascript"></script>');
document.write('<script src="' + bootPATH + 'local/wms.api.js?r='+ Math.random() +'" type="text/javascript" ></script>');
document.write('<script src="' + bootPATH + 'local/wms.vectors.js?r='+ Math.random() +'" type="text/javascript" ></script>');
document.write('<script src="' + bootPATH + 'local/cs.api.js?r='+ Math.random() + '" type="text/javascript" ></script>');
document.write('<script src="' + bootPATH + 'local/Popup.js?r='+ Math.random() + '" type="text/javascript" ></script>');
